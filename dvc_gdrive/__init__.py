...
class GDriveFileSystem(FileSystem):  # pylint:disable=abstract-method
    ...
    REQUIRES: ClassVar[dict[str, str]] = {"pydrive2": "pydrive2"}
    ...
    DEFAULT_GDRIVE_CLIENT_ID = (
        "710796635688-iivsgbgsb6uv1fap6635dhvuei09o66c.apps.googleusercontent.com"
    )
    DEFAULT_GDRIVE_CLIENT_SECRET = "a1Fz59uTpVNeG_VGuSKDLJXv"  # noqa: S105
    ...
    def __init__(self, **config):
        ...
        client_id = config.get("gdrive_client_id", self.DEFAULT_GDRIVE_CLIENT_ID)
        ...
        if use_service_account:
            client_json_file_path = config.get("gdrive_service_account_json_file_path")
        else:
        ...
        if not use_service_account and bool(client_id) != bool(client_secret):
            raise ConfigError(
